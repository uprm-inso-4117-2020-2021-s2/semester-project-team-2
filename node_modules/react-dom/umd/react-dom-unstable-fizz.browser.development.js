...
(function (global, factory) {
  ...
  var reactRootAttribute = stringToPrecomputedChunk(' ' + ROOT_ATTRIBUTE_NAME + '=""');

  function pushReactRoot(target, responseState) {
      ...
      if (hasOwnProperty.call(props, propKey)) {
        ...
        switch (propKey) {
          ...
          case 'dangerouslySetInnerHTML':
            {
              {
                throw Error( "`dangerouslySetInnerHTML` does not work on <option>." );
              }
            }
  ...
  function renderLazyComponent(request, task, type, props) {
