...
function getNextLanes(root, wipLanes) {
  ...
  if ( // TODO: Check for root override, once that lands
...
function shouldTimeSlice(root, lanes) {
  ...
  var SyncDefaultLanes = InputContinuousHydrationLane | InputContinuousLane | DefaultHydrationLane | DefaultLane; // TODO: Check for root override, once that lands
...
var ReactVersion = '17.0.3-experimental-89847bf6e';
...
function performConcurrentWorkOnRoot(root, didTimeout) {
  ...
  var exitStatus = shouldTimeSlice(root, lanes) ? renderRootConcurrent(root, lanes) : // Time slicing is disabled for default updates in this root.
...
function performSyncWorkOnRoot(root) {
  ...
  if (includesSomeLane(lanes, SyncLane)) {
    if (root === workInProgressRoot && includesSomeLane(lanes, workInProgressRootRenderLanes)) {
